                ...
                {product.warehouses.map((wh) => (
                  <div key={wh.inventoryId} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg text-sm font-medium ${wh.available === 0 ? "bg-gray-100 text-gray-400 cursor-not-allowed" : reserving === wh.inventoryId ? "bg-blue-400 text-white cursor-not-allowed" : "bg-blue-600 text-white hover:bg-blue-700"}`}>
